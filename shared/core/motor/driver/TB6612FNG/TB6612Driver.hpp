...
#include "../MotorDriverBase.hpp"

#include "TB6612DriverConfig.hpp"
#include "TB6612DriverMemory.hpp"
...
class TB6612Driver final : public MotorDriverBase
{
public:
    explicit TB6612Driver(const TB6612DriverConfig &config);
